...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ...
    def fetch_objects(self, connections: List[Dict]) -> None:
        """
        ...
        if connections:
            ...
            for connection in connections:
                ...
                for namespace in namespaces:
                    self.add_from_namespace(client, name, namespace, opts)
        else:
    ...
    def get_resources(
        ...
        """
        get_resources uses a dynamic K8SClient to fetch resourches from the K8S API.
        """
    ...
    def add_from_namespace(
        ...
        """
        add_from_namespace adds groups and hosts from a namespace to the inventory.
        """
        vms = {
            vm.metadata.name: vm
