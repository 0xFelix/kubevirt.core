...
def test_add_from_namespace(mocker, inventory, groups, vms, vmis, expected):
    ...
    inventory.add_from_namespace(None, "test", DEFAULT_NAMESPACE, opts)
    ...
    if vms or vmis:
        ...
        assert list(groups.keys()) == ["test", "namespace_default"]
    else:
